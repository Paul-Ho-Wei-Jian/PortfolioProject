...
with midText:
    st.markdown(
        "Thanks you for going through this mini-analysis with me! You can find the python script and notebook on my [Github](https://github.com/Paul-Ho-Wei-Jian/PortfolioProject) :purple_heart:")
